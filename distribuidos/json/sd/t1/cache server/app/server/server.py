...
def serve(is_master=True, port=50052):
...
if __name__ == '__main__':
    ...
    parser.add_argument("port", default=50052, type=int, help="Port number to start the node on")
    parser.add_argument("--master_ip", default="localhost", help="IP address of the master node (required if node_type is 'slave')")
    parser.add_argument("--master_port", type=int, default=50052, help="Port number of the master node (required if node_type is 'slave')")
